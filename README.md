...
| <a name="input_activeport1mask"></a> [activeport1mask](#input\_activeport1mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_activeport2"></a> [activeport2](#input\_activeport2) | NIC 'trust' private address. | `string` | `"172.18.10.69"` | no |
| <a name="input_activeport2mask"></a> [activeport2mask](#input\_activeport2mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_activeport3"></a> [activeport3](#input\_activeport3) | Private HA address for the NIC. | `string` | `"172.18.10.196"` | no |
| <a name="input_activeport3mask"></a> [activeport3mask](#input\_activeport3mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_activeport4"></a> [activeport4](#input\_activeport4) | Private MGMT address for the NIC. | `string` | `"172.18.10.133"` | no |
| <a name="input_activeport4mask"></a> [activeport4mask](#input\_activeport4mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_admin_password"></a> [admin\_password](#input\_admin\_password) | Password to VMSS | `string` | `"Passw0rd"` | no |
| <a name="input_admin_username"></a> [admin\_username](#input\_admin\_username) | Password to VMSS | `string` | `"tsp"` | no |
| <a name="input_adminsport"></a> [adminsport](#input\_adminsport) | n/a | `string` | `"8443"` | no |
| <a name="input_bootstrap-active"></a> [bootstrap-active](#input\_bootstrap-active) | n/a | `string` | `"fgtvma-active.conf"` | no |
| <a name="input_bootstrap-passive"></a> [bootstrap-passive](#input\_bootstrap-passive) | n/a | `string` | `"fgtvmb-active.conf"` | no |
...
| <a name="input_fgtvm2port1mask"></a> [fgtvm2port1mask](#input\_fgtvm2port1mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_fgtvm2port2"></a> [fgtvm2port2](#input\_fgtvm2port2) | NIC 'trust' private address. | `string` | `"172.18.10.70"` | no |
| <a name="input_fgtvm2port2mask"></a> [fgtvm2port2mask](#input\_fgtvm2port2mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_fgtvm2port3"></a> [fgtvm2port3](#input\_fgtvm2port3) | Private HA address for the NIC. | `string` | `"172.18.10.197"` | no |
| <a name="input_fgtvm2port3mask"></a> [fgtvm2port3mask](#input\_fgtvm2port3mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_fgtvm2port4"></a> [fgtvm2port4](#input\_fgtvm2port4) | Private MGMT address for the NIC. | `string` | `"172.18.10.134"` | no |
| <a name="input_fgtvm2port4mask"></a> [fgtvm2port4mask](#input\_fgtvm2port4mask) | n/a | `string` | `"255.255.255.192"` | no |
| <a name="input_license"></a> [license](#input\_license) | license file for the active fgt | `string` | `"license.txt"` | no |
| <a name="input_license2"></a> [license2](#input\_license2) | n/a | `string` | `"license2.txt"` | no |
...
| <a name="input_size"></a> [size](#input\_size) | n/a | `string` | `"Standard_DS3_v2"` | no |
